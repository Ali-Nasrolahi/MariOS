...
add_custom_target(
	...
	COMMAND sudo mkfs.fat -F 16 /dev/${LOOP}p1 > /dev/null
	COMMAND sudo mkfs.fat -F 16 /dev/${LOOP}p2 > /dev/null
	COMMAND sudo mkfs.fat -F 16 /dev/${LOOP}p3 > /dev/null
	COMMAND sudo mkfs.fat -F 16 /dev/${LOOP}p4 > /dev/null
